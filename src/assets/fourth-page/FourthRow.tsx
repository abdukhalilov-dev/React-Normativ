            ...
            <div className="sales">
                ...
                <div className="sales__title">
                    ...
                    <div className="sales__title-btn">
                        <button className="title-btn"><img src="./src/assets/icons/arrow-left.png" alt="" className="btn-img" /></button>
                        <button className="title-btn"><img src="./src/assets/icons/arrow-right-icon.png" alt="" className="btn-img" /></button>
                    </div>
