...
import gamepadSmall from "../../assets/img/gamepad-small.png"
import monitorSmall from "../../assets/img/monitor-small.png"

import bankCash from "../../assets/icons/b-cash.png"
                    ...
                    <div className="inputs-billing">
                        ...
                        <div className="inputs-bill">
                            ...
                            <div className="bill-checkbox">
                                <input className="check-bill" type="checkbox" />
                ...
                <div className="billing-order">
                    ...
                    <div className="bill-monitor order-padding">
                        <div className="bill-p-img">
                            <img src={gamepadSmall} alt="Gamepad" />
                    ...
                    <div className="bill-monitor order-padding">
                        <div className="bill-p-img">
                            <img src={monitorSmall} alt="Monitor" />
                    ...
                    <div className="checkbox-p-order order-padding">
                        <div className="order-bank">
                            <input type="checkbox" className="order-check" />
                            <p className="order-check-p">Bank</p>
                        </div>

                        <div className="order-cards-icons">
                            <img src={bankCash} alt="Cash" />
