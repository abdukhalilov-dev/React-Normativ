            ...
            <div className="CartCounter">
                ...
                <div className="counter-second">
                    <div className="img-name">
                        <img src={monitorSmall} alt="LCD Monitor" />
                ...
                <div className="counter-second">
                    <div className="img-name">
                        <img src={gamepadSmall} alt="LCD Monitor" />
                        <p className="img-text">H1 Gamepad</p>
                    </div>
            ...
            <div className="counter-bottom">
                ...
                <div className="counter-checkout">
                    ...
                    <div className="check-cost-name border-check">
                        ...
                        <p className="check-text">${price1 * quantity1 + price2 * quantity2}</p>
                    </div>
